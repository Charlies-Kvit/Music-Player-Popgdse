...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p>Версия: 0.002(alpha)</p><p>Разработчик: Бутович Глеб Николаевич, разработчик форка Степанов Кирилл Андреевич</p><p>Если вдруг возникли проблемы, заполните форму.</p></body></html>"))
